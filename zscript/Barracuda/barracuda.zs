class BarracudaHandler : EventHandler
{
	...
	{
		let BarracudaAmmo = HDAmmo(e.Thing);
		if (!BarracudaAmmo)
		{
			return;
		}
		switch (BarracudaAmmo.GetClassName())
		{
			case 'HDSlugAmmo':
			case 'HDShellAmmo':
			case 'HDSix12MagSlugs':
			case 'HDSix12MagShells':
				BarracudaAmmo.ItemsThatUseThis.Push("HDBarracuda");
				break;
		}
	}
}
